...
public class MedioContactoDao extends BDConnection{
	...
	public class ContactoDao extends BDconnection{
		...
		public int registrarContacto(MedioContacto medioContacto)
		{
			int resultado=0;
			...
			try
			{
				...
				if(connection != null)
				{
					String query = "insert into MedioContacto (telefono, correo) "
							+ "	values (?, ?);";
		...
		public Integer actualizaPersona(MedioContacto medioContacto) {
		...
		public Integer borrar(MedioContacto medioContacto) {
			System.out.println("--->"+medioContacto.getId());
			try {
				int id = medioContacto.getId();
		...
		public MedioContacto findbyId(int id)
		{
			...
			try
			{
				...
				if(connection != null)
				{
					String query = "select * from MedioContacto where idContacto=? and telefono=?";
