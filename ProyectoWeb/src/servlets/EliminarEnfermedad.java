...
import bussines.EnfermedadBs;

/**
 * Servlet implementation class EliminarEnfermedad
 */
@WebServlet("/EliminarEnfermedad")
public class EliminarEnfermedad extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public EliminarEnfermedad() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		{
			rd = request.getRequestDispatcher("enfermedad.jsp");
			codigo = -1;
		...
		int resultado = contactobs.registraEnfermedad(contacto);
