...
/**
 * Servlet implementation class RegistrarIntento
 */
@WebServlet("/RegistrarIntento")
public class RegistrarIntento extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(institucion==null || institucion.isEmpty()) {
			...
			int resultado= intentobs.registrarIntento(intento);
			if (resultado ==1) {
